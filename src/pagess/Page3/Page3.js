              ...
              <div class="doc-info-left">
                ...
                <div class="doc-info-cont">
                  ...
                  <div className="location" >
                    <p style={{display:'flex',alignItems:'center'}}><AddLocationIcon className='lct'  /> Newyork, USA</p>
                  </div>
										...
										<div class="col-md-12">
											...
											<div class="day-slot">
												<ul>
													<div class="arrow">
														<a href="#">
															<i class="fa fa-chevron-left ch-ic"><ChevronLeftIcon /></i>
														</a>
													</div>
													<li>
														<span>Mon</span>
													...
													<div class="arrow">
														<a href="#">
															<i class="fa fa-chevron-right ch-ic"><ChevronRightIcon /></i>
														</a>
													</div>
												</ul>
											</div>
