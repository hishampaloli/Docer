        ...
        <div class="section-header text-center aling-items-justify specialities-text">
          <Fade bottom>
            <h2 className="cl-head">
              Pick Your Favorite Salon Services at Home Service
            </h2>
          </Fade>
          <Fade bottom>
            <p class="sub-title">
              Best Quality Products | Certified Beauticians | Pocket-Freindly
              Offers | Delhi NCR, Noida,Faridabad, Greater Noida
            </p>
          </Fade>
        </div>
          ...
          <div class="row">
            <div class="col-lg-4">
              ...
              <div class="about-content">
                <Fade bottom>
                  <p>
                    Ab Aap apni Beauty Services ke liye bahut aasani se Reviews
                    or Experience dekh kar Apne Najdeeki Certified Beauty
                    Experts ke saath Salon at Home ka Appointment Book kar sakte
                    hai. Beauty Players aapko 50+ categories ke saath Home Salon
                    Service ko provide karne wale Certified Beauty Experts ke
                    saath jodata hai.
                  </p>
                </Fade>
                <Fade bottom>
